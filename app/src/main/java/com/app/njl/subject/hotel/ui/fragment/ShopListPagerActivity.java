...
public class ShopListPagerActivity extends AppCompatActivity implements View.OnTouchListener, View.OnClickListener, HttpListener<String> {
...
//        mSceneryId = getArguments().getInt("sceneryId", 0);
    ...
    private void initPagerAdapter() {
        ...
        String[] mTitles = getResources().getStringArray(R.array.shop_item_title);
        adapter = new CommonPagerAdapter(getSupportFragmentManager(), fragments, mTitles);
...
//        queryStoresByOptions();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.stay_time_select_ll:
                Intent intent_live = new Intent(getApplicationContext(), CalendarActivity.class);
                startActivityForResult(intent_live, 3);
    ...
    private void createDialog() {
        CustomDialog2.Builder builder = new CustomDialog2.Builder(getApplicationContext());
        builder.create().show();
    }
    ...
    private void queryStoresByOptions() {
        ...
        CallServer.getRequestInstance().add(getApplicationContext(), HttpConstants.QUERY_STORES_BYOPTIONS, request, this, true, true);
    }
