 ...
 */
public class ShopPlayShowSelfServiceActivity extends BaseActivity {
    @Bind(R.id.selfService_playTimeTv)
    TextView playTimeTv; //游玩时间
    @Bind(R.id.shopPlaySelfServiceDetail_backTv)
    TextView backTv; //返回
    @Bind(R.id.shopPlaySelfServiceDetail_addShoppingCartTv)
    TextView addShoppingCartTv; //加入购物车
    @Bind(R.id.shopPlaySelfServiceDetail_buyNowTv)
